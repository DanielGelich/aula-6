...
class TestCalculadoraHorasTrabalhadas(unittest.TestCase):
    ...
    def test_calcular_diferenca_horas(self):
        ...
        self.assertEqual(self.calculadora.calcular_diferenca_horas('0915', '1745'), 8.5)
        self.assertEqual(self.calculadora.calcular_diferenca_horas('12:00', '1430'), 2.5)

    def test_calcular_horas_trabalhadas(self):
        entrada = [('08:00', '1630'), ('0915', '1745'), ('12:00', '1430')]
